...
collision_router[('ball', 'tree')]=collision_ball_ball
collision_router[ ('tree', 'ball') ] = collision_ball_ball
collision_router[ ('tree', 'block') ] = collision_ball_block
collision_router[ ('tree', 'triangle') ] = collision_ball_block
collision_router[('tree', 'tree')]=collision_ball_ball
collision_router[('tree', 'ornament')]=collision_ball_ball
collision_router[ ('ball', 'rotating block') ] = collision_ball_rotating_block
collision_router[ ('ornament', 'rotating tree') ] = collision_ball_rotating_block
collision_router[ ('ornament', 'tree') ] = collision_ball_block
collision_router[ ('rectangle', 'block') ] = collision_ball_block
collision_router[ ('rectangle', 'rectangle') ] = collision_ball_ball
...
def collision(ball, thing, dt):
    ...
    return collision_router[key](ball, thing, dt)
